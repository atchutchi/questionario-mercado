...
class EstacoesMoveisForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'numero_utilizadores': forms.NumberInput(attrs={'class': 'form-control'}),
            ...
            'total_carregamentos': forms.NumberInput(attrs={'class': 'form-control'}),
            ...
            'total_levantamentos': forms.NumberInput(attrs={'class': 'form-control'}),
            ...
            'total_transferencias': forms.NumberInput(attrs={'class': 'form-control'}),
            ...
            'banda_larga_movel': forms.NumberInput(attrs={'class': 'form-control'}),
